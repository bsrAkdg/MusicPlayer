...
import com.bsrakdg.musicplayer.other.Event
...
class MusicServiceConnection(
    ...
    private val mediaBrowser = MediaBrowserCompat(
        ...
        connect() // triggered onConnected on MediaBrowserConnectionCallback
    }

    val transportControls: MediaControllerCompat.TransportControls
        get() = mediaController.transportControls // play, pause, next song
    ...
    // if the user paused song then triggered onMetadataChanged
